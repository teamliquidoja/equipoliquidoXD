...
twitch_miner.mine(
    [
      ...
      Streamer("tiffae", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
      Streamer("bananaslamjamma", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
